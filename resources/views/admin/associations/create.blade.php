                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <select name="announcement_status"
                                    ...
                                    <option value="pending" @selected(old('announcement_status') == 'pending')>Pending
                                    </option>
                                    <option value="active" @selected(old('announcement_status') == 'active')>Active</option>
                                    <option value="suspended" @selected(old('announcement_status') == 'suspended')>Suspended
                                    </option>
                                </select>
                            ...
                            @if(session('uploaded_logo_media'))
                                @php
