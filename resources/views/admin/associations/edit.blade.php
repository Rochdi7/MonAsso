...
<div class="row">
    <div class="col-md-12">
        ...
        <form action="{{ route('admin.associations.update', $association->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            @csrf
            @method('PUT')
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name', $association->name) }}" required>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $association->email) }}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="text" name="address" class="form-control @error('address') is-invalid @enderror" value="{{ old('address', $association->address) }}" required>
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <input type="date" name="creation_date" class="form-control @error('creation_date') is-invalid @enderror" value="{{ old('creation_date', $association->creation_date) }}">
                            @error('creation_date')
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            @if($association->getFirstMedia('logos'))
                                ...
                                <small class="text-muted d-block mt-2">
                                    Current: 
                                    <a href="{{ $media->getUrl() }}" target="_blank">View Logo ({{ $short }})</a>
                                </small>
                            @endif
                        </div>
                        ...
                        <div class="mb-3 col-md-6">
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" name="is_validated" value="1" id="validatedCheck"
                                    @checked(old('is_validated', $association->is_validated))>
