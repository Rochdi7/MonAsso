...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.meetings.update', $meeting->id) }}" method="POST" class="needs-validation" novalidate>
                @csrf
                @method('PUT')
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" id="datetime_picker" name="datetime"
                                        class="form-control @error('datetime') is-invalid @enderror"
                                        value="{{ old('datetime', $meeting->datetime->format('Y-m-d H:i')) }}"
