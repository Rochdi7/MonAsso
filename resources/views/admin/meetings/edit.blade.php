...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.meetings.update', $meeting->id) }}" enctype="multipart/form-data" method="POST"
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                @if($meeting->hasMedia('documents'))
                                    <div class="mt-2">
                                        <small class="text-muted d-block mb-1">Existing Documents:</small>
                                        <ul class="list-unstyled">
                                            @foreach($meeting->getMedia('documents') as $media)
                                                <li>
                                                    <a href="{{ route('media.custom', ['id' => $media->id, 'filename' => rawurlencode($media->file_name)]) }}"
                                                        target="_blank">
                                                        📎 {{ $media->file_name }}
                                                    </a>
                                                </li>
