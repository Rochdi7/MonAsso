...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.contributions.update', $contribution) }}" method="POST" class="needs-validation"
                novalidate>
                @csrf
                @method('PUT')
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select name="association_id"
                                        ...
                                        @foreach($associations as $id => $name)
                                            <option value="{{ $id }}" @selected(old('association_id', $contribution->association_id) == $id)>
                                                {{ $name }}
                                            </option>
                                        @endforeach
                                    </select>
