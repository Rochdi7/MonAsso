...
@section('content')
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="{{ route('admin.membres.update', $membre->id) }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="availability" class="form-control"
                                    rows="2">{{ old('availability', $membre->availability) }}</textarea>
                            </div>

                            <div class="mb-3 col-md-6">
                                <label for="skills" class="form-label">Skills</label>
                                <textarea name="skills" class="form-control"
                                    rows="2">{{ old('skills', $membre->skills) }}</textarea>
                            </div>
                            ...
                            <div class="mb-3 col-md-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="is_active" value="1"
                                        id="activeCheck" @checked(old('is_active', $membre->is_active))>
