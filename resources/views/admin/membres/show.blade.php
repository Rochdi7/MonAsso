            ...
            <div class="card user-card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="user-cover-bg rounded">
                        <img src="{{ URL::asset('build/images/application/img-user-cover-1.jpg') }}" alt="cover"
                    ...
                    <div class="chat-avtar card-user-image">
                        ...
                        <img src="{{ $avatar }}" alt="photo" class="rounded-circle" width="40" height="40">
                    ...
                    <div class="d-grid gap-2">
                        <a href="{{ route('admin.cotisations.create', ['user_id' => $user->id]) }}"
                                    ...
                                    @foreach ($cotisations->sortByDesc('created_at')->values() as $index => $cotisation)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span
                                                    class="text-muted text-sm d-block">{{ $cotisation->created_at->format('h:i A') }}</span>
                                            </td>
