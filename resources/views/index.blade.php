...
<body data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light"
                            ...
                            <div class="row justify-content-center text-center">
                                <div class="col-xxl-5 col-xl-6 col-lg-7 col-md-8 col-sm-10 col-11">
                                    <p class="f-16 mb-3 wow animate__fadeInUp" data-wow-delay="0.6s">
                                        A complete solution for managing memberships, events, donations, and more—all in one platform. Simplify your association's operations today.</p>
                                </div>
                            </div>
                            <div class="wow animate__fadeInUp" data-wow-delay="0.8s">
                                <!-- Replace Live Preview button with Sign Up button -->
                                <a href="#sign-up-section" class="btn btn-primary me-3">Sign Up Now <i
        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-md-8 col-xl-6">
                <p class="text-opacity-75 mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.4s">
                    MonAsso empowers your nonprofit with role-based dashboards, document sharing, and full association management—designed for teams of all sizes.
                </p>
            </div>
        </div>
                ...
                <div class="row justify-content-center text-center gy-sm-4 gy-3">
                    ...
                    @foreach($features as $i => $feature)
                        <div class="col-xl-2 col-md-3 col-6">
                            <div class="card wow animate__fadeInUp h-100" data-wow-delay="0.{{ 5 + $i }}s">
                                <div class="card-body d-flex flex-column justify-content-center align-items-center text-center">
                                    <i class="ph-duotone {{ $feature['icon'] }} text-primary f-36 mb-2"></i>
                                    <h6 class="mb-0 feature-title">{{ $feature['label'] }}</h6>
                                </div>
                            </div>
                        </div>
                    @endforeach
  ...
  <div class="container">
    <div class="row justify-content-center text-center">
      <div class="col-md-8 col-xl-6">
        <h2 class="text-white wow animate__fadeInUp section-title" data-wow-delay="0.2s">Simple, Transparent Pricing</h2>
        <p class="text-white text-opacity-75 mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.4s">
          Choose the plan that's right for your association. All plans come with a 14-day free trial. No credit card required.
        </p>
      </div>
    </div>
  </div>
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-md-6 col-xl-4">
        <div class="price-card wow animate__fadeInUp" data-wow-delay="0.4s">
          ...
          <ul class="list-unstyled text-start text-white text-opacity-50">
            ...
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Limited Feature Access</li>
          ...
          <div class="d-grid">
            <a href="{{ route('register') }}" class="btn btn-outline-light">Start Your Trial</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-xl-4">
        <div class="price-card wow animate__fadeInUp" data-wow-delay="0.2s">
          ...
          <span class="price text-white">199 MAD <small class="f-w-400 text-opacity-50">/mo</small></span>
          <ul class="list-unstyled text-start text-white text-opacity-50">
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Full Feature Access</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Unlimited Members & Events</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Advanced Statistics & Reporting</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Email Support</li>
          </ul>
          <div class="d-grid">
            <a href="{{ route('register') }}" class="btn btn-primary">Choose Pro</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-6 col-xl-4">
        <div class="price-card wow animate__fadeInUp" data-wow-delay="0.6s">
          ...
          <ul class="list-unstyled text-start text-white text-opacity-50">
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Everything in Pro, plus:</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Custom Integrations & API Access</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Dedicated Account Manager</li>
            <li class="my-2"><i class="me-1 ti ti-check text-success"></i> Priority Onboarding & Support</li>
          </ul>
          <div class="d-grid">
        ...
        <div class="row justify-content-center text-center wow animate__fadeInUp" data-wow-delay="0.2s">
            <div class="col-md-8 col-xl-6">
                ...
                <p class="mt-lg-4 mt-2 mb-4 mb-md-5 wow animate__fadeInUp" data-wow-delay="0.2s">
                    MonAsso is the go-to platform for modern associations. We combine simplicity, power, and purpose—so your team can focus on making impact, not managing chaos.
                </p>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0">Every module is designed to match real-world needs of nonprofit organizations, from member tracking to event planning.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0">Your data is protected with strong encryption and hosted securely—ready to support you as your team grows.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            ...
                            <div class="flex-grow-1 ms-3">
                                ...
                                <p class="mb-0">No more switching between apps. Handle members, meetings, documents, and finances from one powerful dashboard.</p>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row align-items-center">
                            <div class="col-lg-8 my-3 text-center text-lg-start">
                                ...
                                <p class="mb-0 text-white text-opacity-75">
                                    Say goodbye to spreadsheets and manual tracking. Join MonAsso and manage members, meetings, and finances—all in one place.
                                </p>
                            </div>
                            <div class="col-lg-4 my-3 text-center text-lg-end">
                                ...
                                <p class="text-white text-opacity-50 mt-3 mb-0">
                                    Need help? <a class="link-light" href="mailto:support@assocmanage.com">support@assocmanage.com</a>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-md-4 wow animate__fadeInUp" data-wow-delay="0.2s">
                   <img src="{{ asset('assets/images/logo/monasso.png') }}" alt="image" class="img-fluid mb-3">

                    <p class="mb-0 mt-3">The all-in-one digital headquarters for modern associations. Built to empower your mission and simplify your management processes.</p>
                </div>
                <div class="col-md-8">
                    <div class="row gy-4">
                        ...
                        <div class="col-sm-4 wow animate__fadeInUp" data-wow-delay="1s">
                            ...
                            <ul class="list-inline footer-sos-link mb-0">
                                <li class="list-inline-item wow animate__fadeInUp" data-wow-delay="0.4s">
                                    <a href="https://twitter.com"><i class="ph-duotone ph-twitter-logo f-20"></i></a>
                                </li>
                                <li class="list-inline-item wow animate__fadeInUp" data-wow-delay="0.5s">
                                    <a href="https://facebook.com"><i class="ph-duotone ph-facebook-logo f-20"></i></a>
                                </li>
                                <li class="list-inline-item wow animate__fadeInUp" data-wow-delay="0.6s">
                                    <a href="https://linkedin.com"><i class="ph-duotone ph-linkedin-logo f-20"></i></a>
                                </li>
                            </ul>
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col my-1 wow animate__fadeInUp" data-wow-delay="0.4s">
                    <p class="m-0">© {{ date('Y') }} MonAsso. All rights reserved.</p>
                </div>
            </div>
        </div>
    </div>
