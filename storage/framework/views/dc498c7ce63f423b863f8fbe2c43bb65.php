                ...
                <div class="card-body">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span
                                class="fw-bold"><?php echo e(number_format($myCotisations[\App\Models\Cotisation::STATUS_PAID] ?? 0, 2, '.', ' ')); ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span
                                class="fw-bold"><?php echo e(number_format($myCotisations[\App\Models\Cotisation::STATUS_PENDING] ?? 0, 2, '.', ' ')); ?>
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <span
                                class="fw-bold"><?php echo e(number_format($myCotisations[\App\Models\Cotisation::STATUS_OVERDUE] ?? 0, 2, '.', ' ')); ?>
        ...
        <div class="col-lg-4">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('admin.meetings.index')); ?>" class="btn btn-sm btn-link-primary">
                        View All
                    </a>
                </div>
                <div class="card-body p-0">
