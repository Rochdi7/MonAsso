<?php $__env->startSection('title', 'Edit Cotisation'); ?>
<?php $__env->startSection('breadcrumb-item', 'Administration'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'Edit Cotisation'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.cotisations.update', $cotisation)); ?>" method="POST" class="needs-validation"
                novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($user->id); ?>" <?php if(old('user_id', $cotisation->user_id) == $user->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <?php $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $association): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($association->id); ?>" <?php if(old('association_id', $cotisation->association_id) == $association->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('year', $cotisation->year)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('amount', $cotisation->amount)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                    ...
                                    <option value="0" <?php if(old('status', $cotisation->status) == 0): echo 'selected'; endif; ?>>Pending</option>
                                    <option value="1" <?php if(old('status', $cotisation->status) == 1): echo 'selected'; endif; ?>>Paid</option>
                                    <option value="2" <?php if(old('status', $cotisation->status) == 2): echo 'selected'; endif; ?>>Overdue</option>
                                    <option value="3" <?php if(old('status', $cotisation->status) == 3): echo 'selected'; endif; ?>>Rejected</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="datetime-local" name="paid_at"
                                    class="form-control <?php $__errorArgs = ['paid_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('paid_at', optional($cotisation->paid_at)->format('Y-m-d\TH:i'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="receipt_number"
                                    class="form-control <?php $__errorArgs = ['receipt_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('receipt_number', $cotisation->receipt_number)); ?>">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer text-end">
                        <a href="<?php echo e(route('admin.cotisations.index')); ?>" class="btn btn-secondary"
                            onclick="rollOutCard(event, this, 'cotisation-form-card')">Cancel</a>
                        <?php if(auth()->user()->hasAnyRole(['admin', 'superadmin', 'board']) && (auth()->user()->hasRole('superadmin') || (int) $cotisation->association_id === (int) auth()->user()->association_id)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views/admin/cotisations/edit.blade.php ENDPATH**/ ?>