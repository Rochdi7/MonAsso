...
<?php $__env->startSection('breadcrumb-item-active', 'Create Permission'); ?>
...
<div class="row">
    <div class="col-12">
        ...
        <div id="permission-create-card" class="card shadow-sm animate__animated animate__rollIn">
            <div class="card-body">
                <form action="<?php echo e(route('admin.permissions.store')); ?>" method="POST" class="needs-validation" novalidate>
                    <?php echo csrf_field(); ?>
                    <div class="row g-3">
                        <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>"
                                ...
                                value="<?php echo e(old('guard_name', 'web')); ?>" required>
                            <div class="invalid-feedback">
                                <?php $__errorArgs = ['guard_name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <?php echo e($message); ?> <?php else: ?> Please enter a guard name (e.g. web). <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                            </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\admin\permissions\create.blade.php ENDPATH**/ ?>