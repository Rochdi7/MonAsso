...
<nav class="pc-sidebar">
  <div class="navbar-wrapper">
    <div class="m-header">
      <a href="//index" class="b-brand text-primary">
        ...
        <div class="dropdown ms-auto">
          <a class="avtar avtar-s btn-link-secondary dropdown-toggle arrow-none me-0" data-bs-toggle="dropdown" href="#"
    ...
    <div class="navbar-content">
      ...
      <?php echo $__env->make('layouts.submenu-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      <ul class="pc-navbar">
    ...
    <div class="card pc-user-card">
      <div class="card-body">
        <div class="d-flex align-items-center">
          <div class="flex-shrink-0">
            <img src="<?php echo e(URL::asset('build/images/user/avatar-1.jpg')); ?>" alt="user-image"
...
<!-- [ Sidebar Menu ] end --><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\layouts\sidebar-moduler.blade.php ENDPATH**/ ?>