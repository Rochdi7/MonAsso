<?php $__env->startSection('title', 'Contributions Management'); ?>
<?php $__env->startSection('breadcrumb-item', 'Administration'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'Manage Contributions'); ?>
    ...
    <div class="col-12">
        <div class="card table-card">
            <div class="card-header d-sm-flex align-items-center justify-content-between">
                ...
                <a href="<?php echo e(route('admin.contributions.create')); ?>" class="btn btn-primary">Add Contribution</a>
                <?php endif; ?>
            </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    ...
                                    <?php elseif($contribution->type == 2): ?>
                                        <span class="badge bg-light-info text-info">Don</span>
                                    <?php else: ?>
                                        <span class="badge bg-light-secondary text-muted">Unknown</span>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo e(number_format($contribution->amount, 2)); ?> MAD</td>
                                <td><?php echo e($contribution->association->name ?? '—'); ?></td>
                                <td><?php echo e(optional($contribution->received_at)->format('Y-m-d') ?? '—'); ?></td>
                                <td><?php echo e($contribution->description ?? '—'); ?></td>
                                
                                <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'admin|superadmin|board')): ?>
                                <td>
                                    
                                    <?php if(auth()->user()->hasAnyRole(['admin', 'board', 'superadmin']) && (auth()->user()->hasRole('superadmin') || auth()->user()->association_id === $contribution->association_id)): ?>
                                    ...
                                    <?php if(auth()->user()->hasAnyRole(['admin', 'superadmin']) && (auth()->user()->hasRole('superadmin') || auth()->user()->association_id === $contribution->association_id)): ?>
                                    <form action="<?php echo e(route('admin.contributions.destroy', $contribution)); ?>" method="POST"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views/admin/contributions/index.blade.php ENDPATH**/ ?>