    ...
    <div class="card user-card shadow-sm">
      <div class="card-body">
        ...
        <div class="user-cover-bg rounded">
          <img src="<?php echo e(URL::asset('build/images/application/img-user-cover-1.jpg')); ?>" alt="cover" class="img-fluid rounded" />
        ...
        <div class="d-grid gap-2">
          <a href="<?php echo e(route('admin.cotisations.create', ['user_id' => $user->id])); ?>" class="btn btn-outline-primary w-100">
                ...
                <?php $__currentLoopData = $cotisations->sortByDesc('created_at')->values(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $cotisation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <span class="text-muted text-sm d-block"><?php echo e($cotisation->created_at->format('h:i A')); ?></span>
                    </td>
