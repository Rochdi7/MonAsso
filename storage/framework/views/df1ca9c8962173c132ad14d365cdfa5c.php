...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    ...
    <div class="row">
     ...
     src="<?php echo e($user->getFirstMediaUrl('profile_photo') ?: asset('assets/images/user/avatar-1.jpg')); ?>"
     alt="User image">
          ...
          Contact <a href="mailto:<?php echo e($user->email); ?>" class="link-primary"><?php echo e($user->email); ?></a> 😍
          </p>
...
unset($__errorArgs, $__bag); ?>"
                name="bio"><?php echo e(old('bio', $user->bio)); ?></textarea>
              <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
