<?php $__env->startSection('title', 'Create Association'); ?>
<?php $__env->startSection('breadcrumb-item', 'Administration'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'New Association'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.associations.store')); ?>" method="POST" enctype="multipart/form-data"
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('creation_date')); ?>" placeholder="Select date" autocomplete="off">
...
unset($__errorArgs, $__bag); ?>">
                                    ...
                                    <option value="pending" <?php if(old('announcement_status') == 'pending'): echo 'selected'; endif; ?>>Pending
                                    </option>
                                    <option value="active" <?php if(old('announcement_status') == 'active'): echo 'selected'; endif; ?>>Active</option>
                                    <option value="suspended" <?php if(old('announcement_status') == 'suspended'): echo 'selected'; endif; ?>>Suspended
                                    </option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php if(session('uploaded_logo_media')): ?>
                                <?php
                                    $media = session('uploaded_logo_media');
                                ?>
                                <div class="mb-3 col-md-6">
                                    <small class="text-muted d-block">Uploaded Logo:</small>
                                    <a href="<?php echo e(route('media.custom', ['id' => $media->id, 'filename' => $media->file_name])); ?>"
                                        ...
                                        <img src="<?php echo e(route('media.custom', ['id' => $media->id, 'filename' => $media->file_name])); ?>"
                                            alt="Uploaded Logo" class="rounded shadow-sm mt-2" width="80">
                                    </a>
                                </div>
                            <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\admin\associations\create.blade.php ENDPATH**/ ?>