...
<body data-pc-direction="ltr" data-pc-preset="preset-1" data-pc-sidebar-theme="light" data-pc-sidebar-caption="true" data-pc-direction="ltr" data-pc-theme="light">
    ...
    <?php echo $__env->make('layouts.sidebar-compact', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(URL::asset('build/js/layout-compact.js')); ?>"></script>

    <?php echo $__env->yieldContent('scripts'); ?>

  </body>
  <!-- [Body] end -->
</html><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\layouts\layout-compact.blade.php ENDPATH**/ ?>