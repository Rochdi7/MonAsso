<?php $__env->startSection('title', 'Edit Contribution'); ?>
<?php $__env->startSection('breadcrumb-item', 'Administration'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'Edit Contribution'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.contributions.update', $contribution)); ?>" method="POST" class="needs-validation"
                novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="1" <?php if(old('type', $contribution->type) == 1): echo 'selected'; endif; ?>>Subvention</option>
                                    <option value="2" <?php if(old('type', $contribution->type) == 2): echo 'selected'; endif; ?>>Don</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('amount', $contribution->amount)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if(old('association_id', $contribution->association_id) == $id): echo 'selected'; endif; ?>>
                                                <?php echo e($name); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="date" name="received_at"
                                    class="form-control <?php $__errorArgs = ['received_at'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('received_at', optional($contribution->received_at)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Enter description..."><?php echo e(old('description', $contribution->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer text-end">
                        <a href="<?php echo e(route('admin.contributions.index')); ?>" class="btn btn-secondary"
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views/admin/contributions/edit.blade.php ENDPATH**/ ?>