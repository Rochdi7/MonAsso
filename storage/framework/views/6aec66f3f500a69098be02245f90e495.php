...
<?php $__env->startSection('breadcrumb-item-active', 'Edit Expense'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.expenses.update', $expense)); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('title', $expense->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('amount', $expense->amount)); ?>" required>
                                <div class="invalid-feedback">
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if(old('association_id', $expense->association_id) == $id): echo 'selected'; endif; ?>>
                                                <?php echo e($name); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('spent_at', optional($expense->spent_at)->format('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Optional description..."><?php echo e(old('description', $expense->description)); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\admin\expenses\edit.blade.php ENDPATH**/ ?>