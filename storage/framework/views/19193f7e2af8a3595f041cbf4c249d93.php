    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1 overflow-hidden">
                <div class="card-body">
                    <img src="<?php echo e(URL::asset('build/images/widget/img-status-4.svg')); ?>" alt="img" class="img-fluid img-bg" />
                    ...
                    <div class="progress" style="height: 7px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($associations['progress']); ?>%" aria-valuenow="<?php echo e($associations['progress']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-6">
            <div class="card statistics-card-1 overflow-hidden">
                <div class="card-body">
                    <img src="<?php echo e(URL::asset('build/images/widget/img-status-5.svg')); ?>" alt="img" class="img-fluid img-bg" />
                    ...
                    <div class="progress" style="height: 7px">
                        <div class="progress-bar bg-primary" role="progressbar" style="width: <?php echo e($users['progress']); ?>%" aria-valuenow="<?php echo e($users['progress']); ?>" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4 col-sm-12">
            <div class="card statistics-card-1 overflow-hidden bg-primary">
                <div class="card-body">
                    <img src="<?php echo e(URL::asset('build/images/widget/img-status-6.svg')); ?>" alt="img" class="img-fluid img-bg" />
                    <h5 class="mb-4 text-white">Total Cotisations (Global)</h5>
                    <div class="d-flex align-items-center mt-3">
                        <h3 class="text-white f-w-300 d-flex align-items-center m-b-0">$<?php echo e(number_format($cotisations['total'], 2)); ?></h3>
                    </div>
        ...
        <div class="col-12">
            <div class="card table-card mt-4">
                <div class="card-header d-flex align-items-center justify-content-between py-3">
                    ...
                    <a href="<?php echo e(route('admin.associations.index')); ?>" class="btn btn-sm btn-link-primary">View All Associations</a>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $topAssociations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assoc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><h6 class="mb-0"><?php echo e($assoc['name']); ?></h6></td>
                                        <td><?php echo e($assoc['members']); ?></td>
                                        <td>$<?php echo e(number_format($assoc['cotisations'], 2)); ?></td>
                                        <td><?php echo e($assoc['meetings']); ?></td>
                                        <td><span class="badge bg-light-<?php echo e($assoc['status_color']); ?>"><?php echo e($assoc['status_label']); ?></span></td>
                                        <td class="text-end">
                                            <div class="btn-group">
