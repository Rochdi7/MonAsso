<?php $__env->startSection('title', 'Complete Statistics'); ?>
<?php $__env->startSection('breadcrumb-item', 'Dashboard'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'Complete Statistics'); ?>
...
<script src="<?php echo e(URL::asset('build/js/widgets/customer-rate-graph.js')); ?>"></script> 
...
<script src="<?php echo e(URL::asset('build/js/widgets/overview-chart-1-2.js')); ?>"></script> 
<script src="<?php echo e(URL::asset('build/js/widgets/transactions-chart.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/widgets/canceled-order-chart.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/widgets/total-order-chart.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/widgets/project-rating-chart.js')); ?>"></script>
<script src="<?php echo e(URL::asset('build/js/widgets/reports-chart.js')); ?>"></script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views\admin\statistics\index.blade.php ENDPATH**/ ?>