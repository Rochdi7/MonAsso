...
<?php $__env->startSection('breadcrumb-item-active', 'Edit Event'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="<?php echo e(route('admin.events.update', $event)); ?>" method="POST" class="needs-validation" novalidate>
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('start_datetime', \Carbon\Carbon::parse($event->start_datetime)->format('Y-m-d\TH:i'))); ?>"
                                        required>
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('end_datetime', \Carbon\Carbon::parse($event->end_datetime)->format('Y-m-d\TH:i'))); ?>"
                                        required>
                                    <span class="input-group-text"><i class="feather icon-clock"></i></span>
                                </div>
...
unset($__errorArgs, $__bag); ?>" required>
                                    <option value="0" <?php if(old('status', $event->status) == 0): echo 'selected'; endif; ?>>⏳ Pending</option>
                                    <option value="1" <?php if(old('status', $event->status) == 1): echo 'selected'; endif; ?>>✔ Confirmed</option>
                                    <option value="2" <?php if(old('status', $event->status) == 2): echo 'selected'; endif; ?>>✖ Cancelled</option>
                                </select>
...
unset($__errorArgs, $__bag); ?>" required>
                                        <?php $__currentLoopData = $associations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($id); ?>" <?php if(old('association_id', $event->association_id) == $id): echo 'selected'; endif; ?>>
                                                <?php echo e($name); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <?php else: ?>
                                <input type="hidden" name="association_id" value="<?php echo e($event->association_id); ?>">
                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>"
                                    placeholder="Enter description..."><?php echo e(old('description', $event->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="card-footer text-end">
                        ...
                        <?php if(auth()->user()->hasAnyRole(['admin', 'superadmin', 'board']) && (auth()->user()->hasRole('superadmin') || (int) $event->association_id === (int) auth()->user()->association_id)): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views/admin/events/edit.blade.php ENDPATH**/ ?>