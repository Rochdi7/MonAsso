<?php $__env->startSection('title', 'User Guide'); ?>
<?php $__env->startSection('breadcrumb-item', 'Help'); ?>
<?php $__env->startSection('breadcrumb-item-active', 'User Guide'); ?>
    ...
    <div class="col-lg-10">
        <div class="card shadow-sm">
            ...
            <div class="card-body">
                ...
                <div class="text-end">
                    <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary"><i class="ph ph-arrow-left me-1"></i> Back to Dashboard</a>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Outlaw\Desktop\Projects\MonAsso\resources\views/user-guide.blade.php ENDPATH**/ ?>